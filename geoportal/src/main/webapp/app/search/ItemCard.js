    ...
    function (declare, lang, array, string, topic, xhr, appTopics, domClass, domConstruct,
        ...
        var oThisClass = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
            ...
            _mouseenter: function (e) {
                topic.publish(appTopics.OnMouseEnterResultItem, {
                    item: this.item
                });
            },

            _mouseleave: function (e) {
                topic.publish(appTopics.OnMouseLeaveResultItem, {
                    item: this.item
                });
            },
            ...
            _renderOwnerAndDate: function (item) {
                ...
                if (AppContext.appConfig.searchResults.showOwner && typeof owner === "string" && owner.length > 0) {
                    idx = owner.indexOf("|");
                    if (idx > 0) owner = owner.substring(0, idx);
            ...
            _setServiceCheckerIcon: function (score, id, type) {
                ...
                if (!info) {
                    info = string.substitute(i18n.item.statusChecker.status, {
                        score: score
                    });
                }
