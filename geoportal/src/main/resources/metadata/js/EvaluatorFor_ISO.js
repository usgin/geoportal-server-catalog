...
//these are the agents cited in the identification section, citedResponsibleParty or pointOfContact
 ...
 G.evalProps(task, item, root, "other_keywords_k", "//gmd:MD_Keywords[not(child::*[local-name()='type'])]/gmd:keyword/gco:CharacterString | //gmd:MD_Keywords[not(child::*[local-name()='type'])]/gmd:keyword/gmx:Anchor");
 
 /* separate index items for instrument and platform */
 G.evalProps(task, item, root, "platform_keywords_k", "//gmd:MD_KeywordTypeCode[@codeListValue='platform']/../../gmd:keyword/gco:CharacterString | //gmd:MD_KeywordTypeCode[@codeListValue='platform']/../../gmd:keyword/gmx:Anchor");
